...
dataDir		        = '/home/featurize/data/datasets'
...
train_imgDir 	    = '%s/Images/%s/' %(dataDir,train_dataSubType)
...
val_imgDir 		    = '%s/Images/%s/' %(dataDir, val_dataSubType)
...
test_imgDir 		= '%s/Images/%s/' %(dataDir, test_dataSubType)

# vocabularies
q_vocab_path = "/home/featurize/data/datasets/Vocabulary/questions_vocabulary.txt" 
a_vocab_path = "/home/featurize/data/datasets/Vocabulary/answers_vocabulary.txt"

# stats about questions
questions_stats_path = "/home/featurize/data/datasets/Vocabulary/questions_stats.txt"